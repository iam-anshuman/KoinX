...
export default function Tokenomics() {
  return (
    <>
      <div className="card w-3/5 bg-slate-50 mx-7 my-4">
        <div className="card-body">
          ...
          <div className="flex">
            ...
            <div className="inline-block mx-10 my-12">
              <div className="my-6">
                <div className="h-4 w-4 rounded-full bg-blue-400 inline-block"></div>
                <span className="mx-6">Crowdsale Investor 80%</span>
              </div>
              <div className="my-6">
                <div className="h-4 inline-block w-4 rounded-full bg-orange-400"></div>
